...
<html>
<head>
  <title>Candidate Job List Page</title>
...
<tr>
<td colspan="5">
<div class="links"><a href="#">&laquo;</a><a></a> <a class="active" href="#">1</a> <a href="#">2</a> <a href="#">3</a> <a href="#">4</a> <a href="#">&raquo;</a></div>
</td>
</tr>
</tfoot>
<tbody>
 <%
   try{
        ...
        CallableStatement st= con.prepareCall("{call greet_logged(?)}");
        ResultSet rs = st.executeQuery("call show_jobs");
        while(rs.next()) { 
        	//String nam=user_id;
 ...
 %>
  ...
  <td><a href="apply.jsp?job_id=<%=rs.getString("job_id")%>"><b><button type="button" class="btn btn-primary btn-xs" onclick="validation();">Apply</button></b></a></td>
